...
import '../../common/managers/favourite_cubit.dart';
import '../../common/managers/favourite_state.dart';
        ...
        builder: (context, state) {
          ...
          if (state.savedProduct.isEmpty) {
            return  Center(child: Column(
             ...
             Text("No Saved Items!", style: TextStyle(color: Theme.of(context).colorScheme.inverseSurface,fontSize: 20, fontWeight: FontWeight.w600),),
                  Text("You don’t have any saved items.\n      Go to home and add some.", style: TextStyle(color: Theme.of(context).colorScheme.inverseSurface,),)
              ],
            ),
            );
          }
