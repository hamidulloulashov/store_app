    ...
    return res.fold(
      ...
      (data) {
        if (data is Map<String, dynamic>) {
          ...
          if (msg.toLowerCase().contains("wrong") || msg.toLowerCase().contains("error")) {
            return Result.error(Exception(msg));
          }
          return Result.ok(msg.isNotEmpty ? msg : "Code sent");
        } else if (data is String) {
          if (data.toLowerCase().contains("wrong") || data.toLowerCase().contains("error")) {
            return Result.error(Exception(data));
          }
  ...
  return res.fold(
    ...
    (data) {
      if (data is Map<String, dynamic>) {
        ...
        if (data == true) {
          return Result.ok("Code verified");
        } else {
          return Result.error(Exception("Code not valid"));
        }
      }
